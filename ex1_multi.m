...
alpha = 0.1;   % This is the best fitting value of alpha 
num_iters = 400;  %andnum iters.
...
% ====================== YOUR CODE HERE ======================
Xp1=[1650,3];
Xp1=featureNormalize(Xp1);
price =[1,Xp1]*theta ; % You should change this
